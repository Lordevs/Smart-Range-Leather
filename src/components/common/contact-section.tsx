...
export function ContactSection({
    ...
    return (
        <section className={cn("w-full bg-[#fdfbf8] py-24 px-6 md:px-12", className)}>
            <div className="mx-auto max-w-7xl">
                ...
                {/* Contact Form Card */}
                <div className="mb-32 overflow-hidden bg-white shadow-[0_10px_50px_rgba(0,0,0,0.05)] border border-neutral-100 lg:flex items-stretch">
                    {/* Left Column - info */}
                        ...
                        <div className="relative flex flex-col justify-between bg-[#FFD18B] p-10 overflow-hidden rounded-xl grow min-h-full">
                            <div className="space-y-12 z-10">
                                <div className="space-y-4">
                                    <h3 className="text-3xl font-bold font-serif text-accent-foreground">Contact Information</h3>
                                    <p className="text-accent-foreground/70 text-lg">Say something to start a live chat!</p>
                                </div>
                    ...
                    <div className="flex-1 p-10 lg:p-16 bg-white flex flex-col">
                        <form className="grid grid-cols-1 gap-x-12 gap-y-10 md:grid-cols-2 grow">
                            <div className="space-y-2">
                                <Label htmlFor="first-name" className="text-sm font-bold text-accent-foreground">First Name</Label>
                                <Input
                                    id="first-name"
                                    type="text"
                                    placeholder=" "
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="last-name" className="text-sm font-bold text-accent-foreground">Last Name</Label>
                                <Input
                                    id="last-name"
                                    type="text"
                                    placeholder="Doe"
                            ...
                            <div className="space-y-2 lg:mt-6">
                                <Label htmlFor="email" className="text-sm font-bold text-accent-foreground">Email</Label>
                                <Input
                                    id="email"
                                    type="email"
                                    placeholder=" "
                            ...
                            <div className="space-y-2 lg:mt-6">
                                <Label htmlFor="phone" className="text-sm font-bold text-accent-foreground">Phone Number</Label>
                                <Input
                                    id="phone"
                                    type="tel"
                            ...
                            <div className="space-y-2 md:col-span-2 lg:mt-6">
                                <Label htmlFor="message" className="text-sm font-bold text-accent-foreground">Message</Label>
                                <Textarea
                                    id="message"
                ...
                <div className="space-y-12">
                    <h3 className="text-5xl font-normal text-accent-foreground font-serif">Our Locations</h3>
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    <div className="text-2xl overflow-hidden w-10 h-8 flex items-center justify-center">
                                        <img src={`/images/flags/${loc.flag}`} alt={loc.country} className="w-full h-full object-cover" />
                                    </div>
                                    <span className="text-2xl font-bold text-accent-foreground">{loc.country}</span>
                                </div>
                                <div className="space-y-2">
                                    <div className="inline-block border-b-2 border-accent-foreground">
                                        <span className="text-base font-bold text-accent-foreground">{loc.type}</span>
                                    </div>

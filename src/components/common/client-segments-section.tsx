...
export function ClientSegmentsSection({
    ...
    return (
        <section className={cn("w-full bg-[#1A1A1A] py-24 px-6 md:px-12 text-white", className)}>
            <div className="mx-auto max-w-7xl">
                ...
                <div className="grid grid-cols-1 gap-x-12 gap-y-16 md:grid-cols-2 lg:grid-cols-3 mb-24">
                    {segments.map((segment, index) => (
                        ...
                        >
                            <div className="flex h-12 w-12 items-center justify-center">
                                <segment.icon className="h-8 w-8 text-primary" strokeWidth={1.5} />
                            </div>
                    ...
                    <motion.div
                        ...
                        className="bg-[#FFD18B] p-10 flex flex-col justify-center space-y-4 text-accent-foreground max-w-[300px]"
                    >

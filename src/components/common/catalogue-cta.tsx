...
export function CatalogueCTA({
  ...
  return (
    <section
      className={cn("w-full bg-foreground py-20 px-6 text-center", className)}>
      <div className="mx-auto max-w-4xl rounded-3xl space-y-8">
        <h2 className="font-serif text-3xl md:text-5xl text-secondary leading-tight">
          {title}
        </h2>

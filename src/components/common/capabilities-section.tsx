...
export function CapabilitiesSection({
    ...
    return (
        <section className={cn("w-full bg-[#121212] py-20 px-6 lg:py-32", className)}>
                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-start">
                    ...
                    <div className="order-1 md:order-2 md:sticky md:top-32">
                        <div className="relative aspect-square w-full">
                            ...
                            <div
                                className="absolute -top-8 md:-top-10 -left-4 md:-left-8 h-40 w-40 rounded-xl bg-[#FE9A00]/20"
                            />

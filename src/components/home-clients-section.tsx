...
import { Store, ShoppingCart, Building2, MousePointer2, Package } from "lucide-react";
    ...
    return (
        <ClientSegmentsSection
            ...
            highlightCard={{
                ...
                description: "Serving global markets with efficient logistics and competitive pricing",
            }}
            stats={stats}
        />
    );

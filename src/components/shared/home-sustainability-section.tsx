...
const sustainabilityFeatures = [
  {
    ...
    description:
      "We source leather from certified suppliers who follow ethical and sustainable practices.",
  },
  {
    icon: Recycle,
    title: "Reduced Waste Production",
    description:
      "Implementing efficient cutting techniques and material optimization to minimize waste.",
  },
  {
    icon: ShieldCheck,
    title: "Safe Working Conditions",
    description:
      "Providing a safe, fair, and supportive environment for all our team members.",
  },
  {
    icon: Droplets,
    title: "Eco-Friendly Finishing",
    description:
      "Using environmentally conscious dyeing and finishing techniques.",
  },
];

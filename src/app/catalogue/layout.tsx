...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_FRONTEND_URL || "https://www.smartrangeleather.com"}/catalogue/`,
  },
  openGraph: {
    title: "Catalogue - Smart Range Leather",
    description:
    ...
    url: `${process.env.NEXT_PUBLIC_FRONTEND_URL || "https://www.smartrangeleather.com"}/catalogue/`,
    images: [
      {

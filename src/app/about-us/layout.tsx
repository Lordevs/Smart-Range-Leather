...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_FRONTEND_URL || "https://www.smartrangeleather.com"}/about-us/`,
  },
  openGraph: {
    ...
    url: `${process.env.NEXT_PUBLIC_FRONTEND_URL || "https://www.smartrangeleather.com"}/about-us/`,
    images: [
      {
